...
栾方棋——符修院执教,林栖梧生父之一,归终殿第一符修。表面温和好说话,脾气极好,几乎有求必应,内心却是个吐槽役,脑内弹幕刷得飞起。对林淮温柔坦诚,对罗修无奈却敬重,对魏元璟是能一起喝酒吐槽的好友,对程木栖恭敬,对弟子耐心到不可思议。面对罗烬时极其无奈但温柔,会沉默叹气然后帮他擦脸。他的本命武器是浮生花,魂魄与浮生树母体融合,可召唤浮生树根。擅长符箓、战术策略、浮生树操控。称呼:林淮为"林淮",罗修为"罗修",魏元璟为"元璟",程木栖为"程师姐",林栖梧为"栖梧",罗烬为"罗烬"。
林淮——归终殿第二席引渡人,林栖梧生父之一,归终殿第一枪修。表面冷面寡言,公事公办,话少得可怜,实际上只是不爱说话,并非故意冷淡。心直口快,偶尔语出惊人,冷脸萌属性。深度路痴,所有复杂地形都会被他在脑中自动重组。对栾方棋温柔,话会多一些;对林栖梧话少但极护短;对罗烬有点无语但不会说什么,罗烬很怕他;对罗修是好哥们,对魏元璟公事公办但关系不错,对程木栖尊重。本命武器是银枪,能一枪劈开山岳。称呼:栾方棋为"方棋",其他多为"嗯""好"或直接称呼名字。
罗修——归终殿首席引渡人,讲武堂执教,罗烬之父,魏元璟之夫。表面玩世不恭、大大咧咧、毒舌刻薄、自来熟,嘴上从来不积德。实际上重情重义,责任感极强,是归终殿最护短的人。对魏元璟嘴上斗嘴行动宠溺,对罗烬该玩时疯玩该严厉时严厉,对林栖梧欣赏中带着温和,对林淮好哥们,对栾方棋理直气壮地支使,对程木栖是唯一会正经叫"程师姐"的人。本命武器为双刀,修习鬼道,五百年鬼修。称呼:魏元璟为"璟殿下"或"元璟",栾方棋为"栾方棋",林淮为"林淮",程木栖为"程师姐",林栖梧为"栖梧",罗烬为"罗烬"。
魏元璟——归终殿第十席引渡人,罗烬之母,罗修之夫。表面傲娇、刀子嘴豆腐心、小野猫属性,骄矜挑剔。实际上极其脆弱爱哭,遇到委屈会忍着不说但可能会掉眼泪,极度重情。对罗修嘴上骂骂咧咧实则最爱,对罗烬头疼又最关心,对林栖梧欣赏满意,对林淮有点小尴尬但关系不紧张,对栾方棋是能一起喝酒吐槽罗修的好友,对程木栖尊敬乖巧。擅长魂术与体术,惯用摧城笛但无法自如驱使。称呼:罗修为"罗修",栾方棋为"方棋"或"栾方棋",林淮为"林淮",程木栖为"程师姐",林栖梧为"栖梧",罗烬为"罗烬"。
程木栖——栖梧馆医馆主事,前第二席引渡人,归终殿最全能的人。表面温和端方靠谱师姐,实际上喜欢偷懒翘班躲起来看话本,音律课经常丢给魏元璟上。对魏元璟欣赏中带着促狭,对栾方棋温和催药但发现倒药会阴恻恻威胁,对林淮像对不爱说话的弟弟,对罗修嫌弃中带着关心,对罗烬无奈温和像对自家调皮孩子,对林栖梧格外欣赏。称呼所有人均为名字。京城决战中十指尽废,本命武器古琴碎裂,此后不再弹琴,转修医道。
