...
{id:'zhouqing',name:'周青',note:'',avatar:'✧',status:'离线',online:false,color:'zhouqing',lastMsg:'没什么，就是闻到了一些酸臭的气息。'},
...
{id:'zhao4',name:'赵四',note:'',avatar:'✿',status:'在线中',online:true,color:'zhao4',lastMsg:'重色轻友！跟人家出外勤！'},
...
{side:'left',sender:'luan',name:'栾方棋',text:'阵法不急，你爹当年阵法也不怎么样。先把你精血催符的脱力问题解决了，比什么都重要。'},
{side:'right',sender:'self',text:'嗯，最近在试程师姐给的方子，喝了三天了。'},
{side:'left',sender:'luan',name:'栾方棋',text:'药按时吃，别为了画符熬夜，你林淮爹看到又该念叨了。'},
{side:'right',sender:'self',text:'知道了娘。'},
{side:'left',sender:'luan',name:'栾方棋',text:'对了，下月初符修院有个试讲课，你来替我上一节？不用正式，就带带新弟子。'},
...
{side:'left',sender:'huai',name:'林淮',text:'浮生树冥想别停。'},
{side:'right',sender:'self',text:'嗯。每日都有做。'},
{side:'left',sender:'huai',name:'林淮',text:'过几天有个外勤，京城周边，你和罗烬一起去。'},
...
{side:'left',sender:'jing',name:'魏元璟',text:'紧张不是理由。下次模拟战时，先做三次深呼吸再起手。'},
...
{side:'left',sender:'jing',name:'魏元璟',text:'不用叫得那么客气。你娘是我同僚，你爹是我……算了。直接叫先生就行。'},
{side:'right',sender:'self',text:'好的先生。'}
],
luo:[
{side:'left',sender:'luo',name:'罗修',text:'期末成绩。符法85，阵法78，魂力82，实战65。'},
{side:'left',sender:'luo',name:'罗修',text:'实战太弱。下次来演武场，我让罗烬陪你练几轮。'},
...
{side:'left',sender:'zhouqing',name:'周青',text:'哦~~~~'},
{side:'right',sender:'self',text:'……有话直说。'},
{side:'left',sender:'zhouqing',name:'周青',text:'没什么，就是闻到了一些酸臭的气息。'},
...
{side:'left',sender:'jing',name:'魏元璟',text:'刀法第一，算你有点天赋。其他科目一塌糊涂，以后在外面少给栾方棋他们添麻烦！'},
{side:'right',sender:'self',text:'知道了娘。'},
...
cheng:[
{side:'left',sender:'cheng',name:'程木栖',text:'你上次外勤肩膀的伤，复查了吗？'},
...
zhao4:[
{side:'left',sender:'zhao4',name:'赵四',text:'你那个刀法练得怎么样了？什么时候切磋一下？'},
{side:'right',sender:'self',text:'随时来。演武场见。'},
{side:'left',sender:'zhao4',name:'赵四',text:'对了，明天符法补考，你作业写了吗？给我抄抄！'},
{side:'right',sender:'self',text:'我写了一半，你要不嫌弃就拿去。'},
{side:'left',sender:'zhao4',name:'赵四',text:'不嫌弃不嫌弃！兄弟救我狗命！'},
{side:'left',sender:'zhao4',name:'赵四',text:'周末要不要去人间鬼市逛逛？听说新来了个摊子卖符纸，便宜得很！'},
{side:'right',sender:'self',text:'周末不行。我跟林栖梧约了去京城北郊。'},
{side:'left',sender:'zhao4',name:'赵四',text:'哦~~~~重色轻友！跟人家出外勤！'},
{side:'right',sender:'self',text:'……滚。'}
],
linxiwu:[
{side:'left',sender:'luan',name:'罗烬',text:'你上次受伤那个地方，好了吗？'},
{side:'right',sender:'self',text:'好了。谢谢。'},
{side:'left',sender:'luan',name:'罗烬',text:'那……下次出外勤一起吗？京城北郊那个。'},
{side:'right',sender:'self',text:'好。'},
{side:'left',sender:'luan',name:'罗烬',text:'好！那我来找你！到时候提前传讯！'},
{side:'right',sender:'self',text:'……嗯。'},
{side:'left',sender:'luan',name:'罗烬',text:'对了，你那个符法笔记……能借我看看吗？补考要用。'},
{side:'right',sender:'self',text:'行。明天带给你。'}
]
}
};
